...
class PenBrush(PenBasic):
    def __init__(self, pg, filler):
        ...
        self.start_drag_coef = 0.08 * self._clean
        self.end_drag_coef = 0.01 * self._clean
        self.start_jiggle = 0.015 * self._clean

        self.base_alpha = 33
        self.random_alpha = 5
        self.random_brightness = 15
        self.random_saturation = 20
        self.random_hue = 5
        self.random_strokeweight = 1
    ...
    def line(self, v1, v2):
        ...
        for _ in range(self.number_parallel):
            ...
            v1_ = v1 + rg * self.brush_width * u + u_ * randomGaussian() * 10
            v2_ = v2 + rg * self.brush_width * u + u_ * randomGaussian() * 7.5
    ...
    def line2(self, v1, v2):
        ...
        self.stroke((self.col[0] + randomGaussian() * self.random_hue, self.col[1] + randomGaussian() * self.random_saturation, self.col[2] + randomGaussian() * self.random_brightness, randomGaussian() * self.random_alpha + self.base_alpha))
        points = []
        ...
        for i in range(0, steps + 1):
            ...
            if random(1) > 0.9 and len(points) >= 2:
                ...
                self.strokeWeight(randomGaussian() * self.random_strokeweight + self.sw)
                self.stroke((self.col[0] + randomGaussian() * self.random_hue, self.col[1] + randomGaussian() * self.random_saturation, self.col[2] + randomGaussian() * self.random_brightness, randomGaussian() * self.random_alpha + self.base_alpha))
