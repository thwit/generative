...
class PenBasic(object):
    ...
    def arc(self, c, w, h, mode=OPEN):
        if self._fill:
            self.filler.arc(PVector(c.x, c.y), w, h, mode, self.fill_col)
    ...
    def ellipse(self, c, w, h):
        if self._fill:
            self.filler.ellipse(PVector(c.x, c.y), w, h, self.fill_col)
    ...
    def point(self, c):
        if self._fill:
            self.filler.point(PVector(c.x, c.y), self.fill_col)
    ...
    def quad(self, a, b, c, d):
        if self._fill:
            self.filler.quad(PVector(a.x, a.y), PVector(b.x, b.y), PVector(c.x, c.y), PVector(d.x, d.y), self.fill_col)
    ...
    def rect(self, ul, w, h):
        if self._fill:
            self.filler.rect(PVector(ul.x, ul.y), w, h, self.fill_col)
    ...
    def square(self, ul, s):
        if self._fill:
            self.filler.square(PVector(ul.x, ul.y), s, self.fill_col)
    ...
    def triangle(self, a, b, c):
        if self._fill:
            self.filler.triangle(PVector(a.x, a.y), PVector(b.x, b.y), PVector(c.x, c.y), self.fill_col)
    ...
    def bezier(self, a1, c1, c2, a2):
        if self._fill:
            self.filler.bezier(PVector(a1.x, a1.y), PVector(c1.x, c1.y), PVector(c2.x, c2.y), PVector(a2.x, a2.y), self.fill_col)
