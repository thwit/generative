...
class Rect(object):
    ...
    def draw(self, pg, pen=False):
        for c in self.circles:
            c.draw(pg)

        if pen:
            td.PenLine(PVector(self.x, self.y), PVector(self.x + self.w, self.y)).draw(pg, self.strk_col)
            td.PenLine(PVector(self.x, self.y), PVector(self.x, self.y + self.h)).draw(pg, self.strk_col)
            
            td.PenLine(PVector(self.x + self.w, self.y), PVector(self.x + self.w, self.y + self.h)).draw(pg, self.strk_col)
            td.PenLine(PVector(self.x, self.y + self.h), PVector(self.x + self.w, self.y + self.h)).draw(pg, self.strk_col)
        else:
            pg.stroke(*self.strk_col)
