...
def to_panto_a4(points, draw_width, draw_height, center=True):
    a4_width = 2100
    a4_height = 2970
    rob_width = 0.145
    rob_height = -0.105
    ...
    x = [p if isinstance(p, int) else map(p.x + x_offset, 0, a4_width, min(0, rob_width), max(0, rob_height)) for p in points]
